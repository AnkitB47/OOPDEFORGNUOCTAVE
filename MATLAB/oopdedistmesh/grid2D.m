classdef(Abstract) grid2D < gridd
    ...
    methods(Access = protected)
       % Basic geometries: free formed boundary, reactangle and ellipse.

        function obj =  polygonGeometry(obj,pv,hmax)
        % POLYGONGEOMETRY
        % Now using distmesh.
        %
        ...
        % Error management
            ...
            % pv must be in the form x y, where x and y are column vectors.
            [m,n] = size(pv);
            if m~=2 && n~=2
                MException('GRID2D:POLYGONGEOMETRY:WRONGFORMAT',...
            ...
            obj.jiggleMesh; obj.jiggleMesh; obj.jiggleMesh;
        end
