    ...
    methods(Access = public)
                ...
                switch nargin
                    ...
                    case 2
                        ...
                        if max(ind)>obj.nElements
                            ME = MException('GRID1D:REFINEMESH',...
                                 ['The number of elements  and the',...
                                 ' index given by the argument do not fit.']);
                            ME.throwAsCaller();
                        end
                    otherwise
                        %
                ...
                otherwise % with additional arguments
                    if obj.nPoints < 200
                        switch obj.nPoints-length(y)
                            ...
                            otherwise
                                ME = MException('GRID1D:WRONGNUMBEROFPOINTS',...
                                     'The number of grid and data points do not fit.');
                                ME.throwAsCaller();
                        end
        ...
        function bval = convCoefficientsMpt(obj,b)
            ...
            elseif isa(b,'double')
                ...
                ME = MException('GRID1D:WRONGFORMAT',...
                     'The format of convection coefficient is wrong.',...
                     'Allowed is function_handle, char string or double.');
                ME.throwAsCaller();
