        ...
        function interval(obj,geo,hmax)
            ...
            switch nargin
                case 2 % obj and geometry
                    if ~isa(geo,'double')
                       MException('GRID1D:WRONGFORMAT',...
                            'The format geometry is wrong.',...
                            'Allowed is only double.').throwAsCaller;
                    end
                ...
                case 3
                    try
                        ...
                        obj.interval(geo);
                        while max(obj.h) > hmax
                            % refine
                            obj.refineMesh();
                        end
                    catch ME
                        % Make catch Octave compatible
                        MException(ME.identifier,ME.message).throw;
                    end
                otherwise
                   %
            end
    ...
    methods(Access = public)
                    ...
                    case 2
                        ...
                        if max(ind)>obj.nElements
                            MException('GRID1D:REFINEMESH',...
                                ...
                                ' index given by the argument do not fit.']).throwAsCaller;
                        end
                    otherwise
                        %
                end
                ...
                otherwise % with additional arguments
                    if obj.nPoints < 200
                        switch obj.nPoints-length(y)
                            ...
                            otherwise
                                MException('GRID1D:WRONGNUMBEROFPOINTS',...
                                    'The number of grid nodes and data points do not fit.').throwAsCaller
                        end
        ...
        function bval = convCoefficientsMpt(obj,b)
            ...
            elseif isa(b,'double')
                switch length(b)
                    ...
                    otherwise
                        MException('GRID1D:WRONGFORMAT',...
                            'The format of convection coefficient is wrong.',...
                            'It must be scalar or a vector of length nElements or nPoints',...
                            'of class double.').throwAsCaller;
                ...
                MException('GRID1D:WRONGFORMAT',...
                            'The format of convection coefficient is wrong.',...
                            'Allowed is function_handle, char string or double.').throwAsCaller;
        ...
        function [cval,aval,fval] = aCoefficientsMpt(obj,c,a,f)
            ...
            elseif isa(c,'inline')
                ...
                MException('GRID1D:WRONGFORMAT',...
                            'The format of diffusion coefficient is wrong.',...
                            'Allowed is function_handle, char string or double.').throwAsCaller;
            ...
            elseif isa(a,'double')
                ...
                elseif length(a)==1
                    aval = a*ones(1,obj.nElements);
                     ...
                     MException('GRID1D:WRONGFORMAT',...
                            'The format of mass coefficient is wrong.',...
                            'It must be scalar or a vector of length nElements or nPoints',...
                            'of class double.').throwAsCaller;
                end
            elseif isa(a,'inline')
            ...
            elseif isa(f,'double')
                ...
                elseif length(f)==1
                    ...
                    MException('GRID1D:WRONGFORMAT',...
                            'The format of source function is wrong.',...
                            'It must be scalar or a vector of length nElements or nPoints',...
                            'of class double.').throwAsCaller;
                end
            elseif isa(f,'inline')
