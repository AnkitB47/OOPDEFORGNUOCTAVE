        ...
        function obj = UnitSquare(hmax)
            ...
            switch nargin
                case 0
                    ...
                    MException('UNITSQUARE:MissingArgument',...
                               'Missing argument: Mesh-width h must be given.').throwAsCaller;
                case 1
                    if hmax <= 0
                        MException('UNITSQUARE:MissformedArgument',...
                        'Missformed argument: Mesh-width h must be greater zero').throwAsCaller;
                    end
